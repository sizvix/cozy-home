...
var isDate = __webpack_require__(379)
...
var convert = __webpack_require__(352).convert;
var bodyStream = __webpack_require__(374);
...
var startOfISOWeek = __webpack_require__(98)
...
var startOfWeek = __webpack_require__(142)
...
__webpack_require__(375).inherits(FetchError, Error);
...
var getISOYear = __webpack_require__(97)
var startOfISOWeek = __webpack_require__(98)
...
var startOfDay = __webpack_require__(99)
...
var parse = __webpack_require__(1)
var getDaysInMonth = __webpack_require__(380)
...
var fetch = __webpack_require__(349);

var exceptions = __webpack_require__(378);
...
var https = __webpack_require__(350);
var zlib = __webpack_require__(351);
...
var Request = __webpack_require__(377);
var FetchError = __webpack_require__(137);
...
var iconvLite = __webpack_require__(353);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(372);
...
var bomHandling = __webpack_require__(354),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(355); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(365) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __webpack_require__(366) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(95).concat(__webpack_require__(135)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(95).concat(__webpack_require__(135)) },
        gb18030: function() { return __webpack_require__(367) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(368) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(136).concat(__webpack_require__(369)) },
...
var addDays = __webpack_require__(138)
...
var parse = __webpack_require__(1)
var differenceInCalendarMonths = __webpack_require__(398)
var compareAsc = __webpack_require__(141)
...
var differenceInMilliseconds = __webpack_require__(145)
...
var buildDistanceInWordsLocale = __webpack_require__(442)
var buildFormatLocale = __webpack_require__(443)
...
var parse = __webpack_require__(1)
var startOfISOWeek = __webpack_require__(98)
var startOfISOYear = __webpack_require__(140)
...
var addMilliseconds = __webpack_require__(139)
...
var getISOYear = __webpack_require__(97)
var setISOYear = __webpack_require__(392)
...
var parse = __webpack_require__(1)
var startOfISOYear = __webpack_require__(140)
var differenceInCalendarDays = __webpack_require__(143)
...
var addMonths = __webpack_require__(144)
...
var addISOYears = __webpack_require__(391)
...
var compareDesc = __webpack_require__(382)
var parse = __webpack_require__(1)
var differenceInSeconds = __webpack_require__(384)
var differenceInMonths = __webpack_require__(383)
var enLocale = __webpack_require__(385)
...
var parse = __webpack_require__(1)
var startOfYear = __webpack_require__(407)
var differenceInCalendarDays = __webpack_require__(143)
...
var startOfHour = __webpack_require__(412)
...
var isSameWeek = __webpack_require__(388)
...
var startOfMinute = __webpack_require__(416)
...
var startOfQuarter = __webpack_require__(419)
...
var startOfSecond = __webpack_require__(421)
...
var _require = __webpack_require__(427),
    isKonnectorUserError = _require.isKonnectorUserError;

var cozyFetch = __webpack_require__(348);
...
exports.getMostAccurateErrorKey = exports.JOB_STATE = exports.KONNECTOR_RESULT_STATE = exports.KONNECTOR_STATE = exports.KONNECTORS_RESULT_DOCTYPE = exports.KONNECTORS_DOCTYPE = exports.ERROR_TYPES = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* konnector lib ready to be added to cozy-client-js */
...
exports.subscribeAll = subscribeAll;
exports.subscribeAllResults = subscribeAllResults;
exports.install = install;
exports.addFolderPermission = addFolderPermission;
exports.deleteFolderPermission = deleteFolderPermission;
exports.run = run;
...
var _realtime = __webpack_require__(389);

var realtime = _interopRequireWildcard(_realtime);

var _jobs = __webpack_require__(428);
...
var KONNECTORS_RESULT_DOCTYPE = exports.KONNECTORS_RESULT_DOCTYPE = 'io.cozy.konnectors.result';

var KONNECTOR_STATE = exports.KONNECTOR_STATE = {
  // Available state
  AVAILABLE: 'available',
...
var JOB_STATE = exports.JOB_STATE = {
  READY: 'ready',
  ERRORED: 'errored',
  DONE: 'done'
};
...
function sanitizeSlug(konnector) {
  return konnector && _extends({}, konnector, {
    slug: konnector.slug || konnector.attributes.slug
  });
}

function fetchManifest(cozy, source) {
  return source ? cozy.fetchJSON('GET', '/konnectors/manifests?Source=' + encodeURIComponent(source)) : Promise.reject(new Error('A source must be provided to fetch the konnector manifest'));
}
...
function findBySlug(cozy, slug) {
  ...
  return getSlugIndex(cozy).then(function (index) {
    ...
    return sanitizeSlug(konnector);
  });
}

function unlinkFolder(cozy, konnector, folderId) {
  return !konnector._id ? /**
                           ...
                           * fail.
                           */
  Promise.resolve(new Error("konnector doesn't have available id")) : cozy.fetchJSON('DELETE', '/data/io.cozy.konnectors/' + encodeURIComponent(konnector._id) + '/relationships/references', {
    data: [{
      type: 'io.cozy.files',
      id: folderId
    }]
  }).then(function () {
    return deleteFolderPermission(cozy, konnector);
  });
}

function fetchResult(cozy, konnector) {
  if (!konnector) return Promise.reject(new Error('No konnector'));
  var slug = konnector.slug || konnector.attributes.slug;
  return cozy.data.find(KONNECTORS_RESULT_DOCTYPE, slug);
}

function findAll(cozy) {
  return findAllDocuments(cozy, KONNECTORS_DOCTYPE).then(function (konnectors) {
    return konnectors.map(sanitizeSlug);
  });
}

function findAllResults(cozy) {
  return findAllDocuments(cozy, KONNECTORS_RESULT_DOCTYPE);
}

function findAllDocuments(cozy, doctype) {
  return cozy.fetchJSON('GET', '/data/' + doctype + '/_all_docs?include_docs=true').then(function (result) {
...
function install(cozy, konnector) {
  ...
  var slug = konnector.slug,
      ...
      parameters = konnector.parameters;

  var urlParams = 'Source=' + encodeURIComponent(source);
  ...
  return findBySlug(cozy, slug).catch(function (error) {
    if (error.status !== '404') throw error;
    return null;
  }).then(function (konnector) {
    return konnector ? // Need JSONAPI format
    cozy.data.find(KONNECTORS_DOCTYPE, konnector._id) : cozy.fetchJSON('POST', '/konnectors/' + slug + '?' + urlParams);
  }).then(function (konnector) {
...
function waitForKonnectorReady(cozy, konnector, timeout) {
  return new Promise(function (resolve, reject) {
    ...
    var idInterval = setInterval(function () {
      cozy.data.find(KONNECTORS_DOCTYPE, konnector._id).then(function (konnectorResponse) {
...
function deleteFolderPermission(cozy, konnector) {
  return patchFolderPermission(cozy, konnector);
}

function run(cozy, konnector, account) {
  var slug = konnector.attributes ? konnector.attributes.slug : konnector.slug;
  if (!slug) {
  ...
  return cozy.jobs.create('konnector', jobAttributes, {
    ...
    return waitForJobFinished(cozy, job);
  });
}
...
function waitForJobFinished(cozy, job) {
  return new Promise(function (resolve, reject) {
    jobs.subscribe(cozy, job).then(function (subscription) {
      subscription.onUpdate(function (job) {
...
function createTrigger(cozy, konnector, account, folder) {
  var options = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
...
exports.JOB_STATE = exports.JOBS_DOCTYPE = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* jobs lib ready to be added to cozy-client-js */


exports.findById = findById;
exports.findQueuedOrRunning = findQueuedOrRunning;
exports.subscribe = subscribe;
exports.subscribeAll = subscribeAll;

var _dateFns = __webpack_require__(429);
...
function decode(job) {
  ...
  return _extends({}, job, job.message);
}

function findById(cozy, id) {
  return cozy.fetchJSON('GET', '/jobs/' + id);
}

function findQueuedOrRunning(cozy, limitDate) {
  return cozy.fetchJSON('GET', '/jobs/queue/konnector').then(function (results) {
    return results.map(function (result) {
      return decode(result.attributes);
    });
  }).then(function (jobs) {
    return limitDate ? jobs.filter(function (job) {
      return _dateFns2.default.isAfter(job.queued_at, limitDate);
    }) : jobs;
  });
}
...
module.exports = {
  addDays: __webpack_require__(138),
  addHours: __webpack_require__(390),
  addISOYears: __webpack_require__(391),
  addMilliseconds: __webpack_require__(139),
  addMinutes: __webpack_require__(393),
  addMonths: __webpack_require__(144),
  addQuarters: __webpack_require__(394),
  addSeconds: __webpack_require__(395),
  addWeeks: __webpack_require__(381),
  addYears: __webpack_require__(396),
  areRangesOverlapping: __webpack_require__(430),
  closestIndexTo: __webpack_require__(431),
  closestTo: __webpack_require__(432),
  compareAsc: __webpack_require__(141),
  compareDesc: __webpack_require__(382),
  differenceInCalendarDays: __webpack_require__(143),
  differenceInCalendarISOWeeks: __webpack_require__(433),
  differenceInCalendarISOYears: __webpack_require__(397),
  differenceInCalendarMonths: __webpack_require__(398),
  differenceInCalendarQuarters: __webpack_require__(434),
  differenceInCalendarWeeks: __webpack_require__(435),
  differenceInCalendarYears: __webpack_require__(400),
  differenceInDays: __webpack_require__(401),
  differenceInHours: __webpack_require__(436),
  differenceInISOYears: __webpack_require__(437),
  differenceInMilliseconds: __webpack_require__(145),
  differenceInMinutes: __webpack_require__(438),
  differenceInMonths: __webpack_require__(383),
  differenceInQuarters: __webpack_require__(439),
  differenceInSeconds: __webpack_require__(384),
  differenceInWeeks: __webpack_require__(440),
  differenceInYears: __webpack_require__(441),
  distanceInWords: __webpack_require__(403),
  distanceInWordsStrict: __webpack_require__(445),
  distanceInWordsToNow: __webpack_require__(446),
  eachDay: __webpack_require__(447),
  endOfDay: __webpack_require__(386),
  endOfHour: __webpack_require__(448),
  endOfISOWeek: __webpack_require__(449),
  endOfISOYear: __webpack_require__(450),
  endOfMinute: __webpack_require__(451),
  endOfMonth: __webpack_require__(405),
  endOfQuarter: __webpack_require__(452),
  endOfSecond: __webpack_require__(453),
  endOfToday: __webpack_require__(454),
  endOfTomorrow: __webpack_require__(455),
  endOfWeek: __webpack_require__(404),
  endOfYear: __webpack_require__(456),
  endOfYesterday: __webpack_require__(457),
  format: __webpack_require__(458),
  getDate: __webpack_require__(459),
  getDay: __webpack_require__(460),
  getDayOfYear: __webpack_require__(406),
  getDaysInMonth: __webpack_require__(380),
  getDaysInYear: __webpack_require__(461),
  getHours: __webpack_require__(462),
  getISODay: __webpack_require__(410),
  getISOWeek: __webpack_require__(387),
  getISOWeeksInYear: __webpack_require__(463),
  getISOYear: __webpack_require__(97),
  getMilliseconds: __webpack_require__(464),
  getMinutes: __webpack_require__(465),
  getMonth: __webpack_require__(466),
  getOverlappingDaysInRanges: __webpack_require__(467),
  getQuarter: __webpack_require__(399),
  getSeconds: __webpack_require__(468),
  getTime: __webpack_require__(469),
  getYear: __webpack_require__(470),
  isAfter: __webpack_require__(471),
  isBefore: __webpack_require__(472),
  isDate: __webpack_require__(379),
  isEqual: __webpack_require__(473),
  isFirstDayOfMonth: __webpack_require__(474),
  isFriday: __webpack_require__(475),
  isFuture: __webpack_require__(476),
  isLastDayOfMonth: __webpack_require__(477),
  isLeapYear: __webpack_require__(409),
  isMonday: __webpack_require__(478),
  isPast: __webpack_require__(479),
  isSameDay: __webpack_require__(480),
  isSameHour: __webpack_require__(411),
  isSameISOWeek: __webpack_require__(413),
  isSameISOYear: __webpack_require__(414),
  isSameMinute: __webpack_require__(415),
  isSameMonth: __webpack_require__(417),
  isSameQuarter: __webpack_require__(418),
  isSameSecond: __webpack_require__(420),
  isSameWeek: __webpack_require__(388),
  isSameYear: __webpack_require__(422),
  isSaturday: __webpack_require__(481),
  isSunday: __webpack_require__(482),
  isThisHour: __webpack_require__(483),
  isThisISOWeek: __webpack_require__(484),
  isThisISOYear: __webpack_require__(485),
  isThisMinute: __webpack_require__(486),
  isThisMonth: __webpack_require__(487),
  isThisQuarter: __webpack_require__(488),
  isThisSecond: __webpack_require__(489),
  isThisWeek: __webpack_require__(490),
  isThisYear: __webpack_require__(491),
  isThursday: __webpack_require__(492),
  isToday: __webpack_require__(493),
  isTomorrow: __webpack_require__(494),
  isTuesday: __webpack_require__(495),
  isValid: __webpack_require__(408),
  isWednesday: __webpack_require__(496),
  isWeekend: __webpack_require__(497),
  isWithinRange: __webpack_require__(498),
  isYesterday: __webpack_require__(499),
  lastDayOfISOWeek: __webpack_require__(500),
  lastDayOfISOYear: __webpack_require__(501),
  lastDayOfMonth: __webpack_require__(502),
  lastDayOfQuarter: __webpack_require__(503),
  lastDayOfWeek: __webpack_require__(423),
  lastDayOfYear: __webpack_require__(504),
  max: __webpack_require__(505),
  min: __webpack_require__(506),
  parse: __webpack_require__(1),
  setDate: __webpack_require__(507),
  setDay: __webpack_require__(508),
  setDayOfYear: __webpack_require__(509),
  setHours: __webpack_require__(510),
  setISODay: __webpack_require__(511),
  setISOWeek: __webpack_require__(512),
  setISOYear: __webpack_require__(392),
  setMilliseconds: __webpack_require__(513),
  setMinutes: __webpack_require__(514),
  setMonth: __webpack_require__(424),
  setQuarter: __webpack_require__(515),
  setSeconds: __webpack_require__(516),
  setYear: __webpack_require__(517),
  startOfDay: __webpack_require__(99),
  startOfHour: __webpack_require__(412),
  startOfISOWeek: __webpack_require__(98),
  startOfISOYear: __webpack_require__(140),
  startOfMinute: __webpack_require__(416),
  startOfMonth: __webpack_require__(518),
  startOfQuarter: __webpack_require__(419),
  startOfSecond: __webpack_require__(421),
  startOfToday: __webpack_require__(519),
  startOfTomorrow: __webpack_require__(520),
  startOfWeek: __webpack_require__(142),
  startOfYear: __webpack_require__(407),
  startOfYesterday: __webpack_require__(521),
  subDays: __webpack_require__(522),
  subHours: __webpack_require__(523),
  subISOYears: __webpack_require__(402),
  subMilliseconds: __webpack_require__(524),
  subMinutes: __webpack_require__(525),
  subMonths: __webpack_require__(526),
  subQuarters: __webpack_require__(527),
  subSeconds: __webpack_require__(528),
  subWeeks: __webpack_require__(529),
  subYears: __webpack_require__(530)
}
...
var getQuarter = __webpack_require__(399)
var parse = __webpack_require__(1)
...
var parse = __webpack_require__(1)
var differenceInCalendarISOYears = __webpack_require__(397)
var compareAsc = __webpack_require__(141)
var subISOYears = __webpack_require__(402)
...
var differenceInDays = __webpack_require__(401)
...
var parse = __webpack_require__(1)
var differenceInCalendarYears = __webpack_require__(400)
var compareAsc = __webpack_require__(141)
...
var buildFormattingTokensRegExp = __webpack_require__(444)
...
var distanceInWords = __webpack_require__(403)
...
var endOfWeek = __webpack_require__(404)
...
var endOfDay = __webpack_require__(386)
...
var getDayOfYear = __webpack_require__(406)
var getISOWeek = __webpack_require__(387)
var getISOYear = __webpack_require__(97)
var parse = __webpack_require__(1)
var isValid = __webpack_require__(408)
var enLocale = __webpack_require__(385)
...
var isLeapYear = __webpack_require__(409)
...
var startOfISOYear = __webpack_require__(140)
var addWeeks = __webpack_require__(381)
...
var parse = __webpack_require__(1)
var endOfDay = __webpack_require__(386)
var endOfMonth = __webpack_require__(405)
...
var isSameHour = __webpack_require__(411)
...
var isSameISOWeek = __webpack_require__(413)
...
var isSameISOYear = __webpack_require__(414)
...
var isSameMinute = __webpack_require__(415)
...
var isSameMonth = __webpack_require__(417)
...
var isSameQuarter = __webpack_require__(418)
...
var isSameSecond = __webpack_require__(420)
...
var isSameYear = __webpack_require__(422)
...
var lastDayOfWeek = __webpack_require__(423)
...
var parse = __webpack_require__(1)
var addDays = __webpack_require__(138)
var getISODay = __webpack_require__(410)
...
var parse = __webpack_require__(1)
var setMonth = __webpack_require__(424)
...
var addHours = __webpack_require__(390)
...
var addMinutes = __webpack_require__(393)
...
var addQuarters = __webpack_require__(394)
...
var addSeconds = __webpack_require__(395)
...
var addYears = __webpack_require__(396)
